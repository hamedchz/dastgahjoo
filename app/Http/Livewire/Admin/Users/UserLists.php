...
class UserLists extends Component
{
    ...
    public function showModalUsers($id)
    {
        $package_history = PackageHistory::where('user_id', $id)
            ->orderBy('id', 'desc')
            ->get();
        $this->package_histories = $package_history;
        $this->dispatchBrowserEvent('show-package');
    }
    ...
    public function render()
    {
        ...
        $roles = DB::table('roles')
            ->selectRaw('roles.id, roles.name, count(role_user.user_id) as count')

...
class ProductVendorMessageList extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.admin.seller.message.products.list.product-vendor-message-list',['messages'=>$messages])->layout('layouts.admin.app');
    }
}

        ...
        <div class="display-align top-pad">
          <div class="col-lg-12">
              ...
              <div class="hide-mobile">
               <h2>جستجوی آنلاین ماشین آلات</h2>
               <p>
                چه به دنبال نوع خاصی از ماشین باشید و چه سال ساخت خاص: کافی است نام یا مشخصات دستگاه مورد نظر را در ماسک جستجو وارد کنید تا پیشنهادات مربوط به ماشین های دست دوم نمایش داده شود. در RESALE می توانید به عنوان مثال زیر را در دسته های ماشین های دست دوم جستجو کنید: </p>              </div>
          ...
          @foreach ($categories as $category )
           ...
           @endforeach
              ...
              <div class="col-lg-12   text center-align mx-auto">
                 <a class="btn-all btn-green" href="" target="_blank">ارسال درخواست استعلام</a>
              </div>
        </div>
      </div>
        <hr>
      ...
      <div class="container des-text">
        <div class="display-align">
          <div class="col-md-12 mt-3">
            <h3>ماشین های دست دوم را با قیمت های مناسب بخرید</h3>
            <p>
              هزینه‌های خرید بالا و چرخه عمر کوتاه:
               <b>ماشین‌های مستعمل صرف نظر از اندازه شرکت اهمیت فزاینده‌ای برای شرکت‌ها پیدا می‌کنند.</b>
                به‌ویژه زمانی که یک دستگاه در فرآیند تولید خراب می‌شود و زمان آن به پایان می‌رسد، زیرا یک تولید تولید می‌شود. توقف تهدید می کند، ماشین های مستعمل جایگزینی واقعی برای دستگاه های جدید می شوند.
              اما حتی اگر بخواهید پارک ماشین خود را گسترش دهید تا کارایی را بیش از پیش افزایش دهید، کالاهای دست دوم جایگزینی عالی در مقایسه با ماشین آلات جدید می شوند. چه 
              <a href="product-list.html" title="">ماشین های چاپ</a>،
              <a href="../en/agriculture-machines/rs-9/" title="">ماشین آلات کشاورزی</a>
               یا <a href="product-list.html" title="">دستگاه های بسته بندی</a>:
              ماشین های دست دوم نه تنها مقرون به صرفه تر هستند، بلکه به سرعت در دسترس هستند. علاوه بر این، اغلب می توانند از نظر کیفیت با تجهیزات جدید رقابت کنند.
            </p>

            <h3>خرید و فروش در قدیمی ترین بازار ماشین آلات دست دوم</h3>
            <p>
              شما به <a href="product-list.html" title="">فلزکاری</a>
               یا 
              <a href="product-list.html" title=""> ماشین آلات نجاری</a>
              و آیا به دنبال ماشین آلات دست دوم مناسب هستید؟
              یا <a href="product-list.html" title="">ماشین ساخت و ساز</a> 
              یا تجهیزات پردازش کاغذی دارید که می خواهید بفروشید؟
            </p>
            <p>
              <b> قدیمی‌ترین بازار ماشین‌های کارکرده در سراسر جهان است و تامین‌کنندگان و فروشندگان را گرد هم می‌آورد.</b>
               به عنوان اولین بازار ماشین‌های دست دوم در اینترنت، ما در سال 1996 آنلاین شدیم و از آن زمان با تقلیدکنندگان زیادی مخالفت کردیم. ما فقط بستر را برای فروشندگان تجهیزات دست دوم فراهم می کنیم - اما هیچ محصولی را برای فروش ارائه نمی دهیم.
            </p>

            <h4>ماشین آلات دست دوم: کیفیت با قیمت بالا</h4>
            <p>
              ماشین‌آلات یا ماشین‌های چاپ: در  ماشین‌آلات تولیدکنندگان معروف را با قیمت‌های منصفانه خواهید یافت. 
              <b>به‌عنوان یک پلت‌فرم پیشرو ماشین‌آلات دست دوم برای صنایع ماشین‌آلات متعدد، ما بیش از 100000 ماشین‌آلات و تجهیزات مستعمل و همچنین بیش از 20000 فروشنده ثبت‌شده ارائه می‌دهیم.</b>
              می‌توانید ماشین‌های دست دوم را در  با قیمت ثابت بخرید یا می‌توانید در مزایده برنده شوید. ما خودمان هزینه های خود را با کار کارآمد پایین نگه می داریم و می توانیم این هزینه ها را مستقیماً در قالب قیمت های مطلوب به مشتریان خود منتقل کنیم.
            </p>  
          </div>
        </div>
      </div>
        ...
        <!-- قسمت نظرات -->
        <div id="comments" class="display-align bottom-margin2">

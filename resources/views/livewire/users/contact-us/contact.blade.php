          ...
          <div class="container top-titr">
            <div class="display-align bottom-margin2">
              <div class="col-lg-8 text center-align mx-auto">
                <h1><strong>تماس با ما</strong></h1>
              </div>
            </div>
              ...
              <form method="post" name="" action="" wire:submit.prevent = "store" accept-charset="utf-8">
                ...
                <fieldset>
                  <div class="form-top">
                    ...
                    <div class="icon-form">
                      <h2>ما با کمال میل به سوالات شما پاسخ خواهیم داد</h2>
                  ...
                  <div class="form-middle"></div>
                   ...
                   <div class="form-bottom">
                    <div class="display-align">
                      <div class="col-lg-6">
                        ...
                        <div class="align-form">
                          ...
                          @error('subject')<div class="text-danger " style="text-align:right;padding-top:5px;padding-right:10px;">{{ $message }}</div> @enderror
                    ...
                    <div class="align-form">
                        ...
                        @error('description')<div class="text-danger " style="text-align:right;padding-top:5px;padding-right:10px;">{{ $message }}</div> @enderror

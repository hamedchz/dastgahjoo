                ...
                <span class="text-muted" style="font-weight: 400;">سطح دسته اول: </span>
                 <span class="text-muted" style="font-weight: 600;">رده 100 </span>
                  <h1 class="center-align" style="font-size: 24px;">
                    <span class="text-danger">ماشین آلات فلزکاری</span>
        ...
        <nav aria-label="breadcrumb" class="">
          <ol class="address-crumb" style="border-radius: 0">
            ...
            <li class="address-crumb-item"><a href="search.html">
              <span class="cut-text">ماشین آلات فلزکاری</span>
            </a>
          </li>
                ...
                <tr class="gray-bg-plus">
                    ...
                    <td>
                      <span class="product-title">
                        <a href="search.html">لوازم جانبی ماشین ابزار</a>
                      </span>
        ...
        <div class="container top-group" style="background-color: white;">
          <div class="display-align">
            <div class="col-lg-7 machine-top py-1">
              <span class="category-code">107 
                <a href="#" style="color: #5faeff;">ورق کاری</a>
              </span>
            </div>
            <div class="col-lg-5 machine-top py-1">
              <span class="category-code">تاریخ: 17.03.2022</span>
                ...
                <div class="col-sm center-align fill">
                  <div class="picture">
                    <a href="product-detail.html">
                      <img src="img/machinepics11.jpg" >                
                    </a>
    
                    <div class="bottom-center">
                      <button class="btn-all btn-all-small btn-green" style="margin: 10px; ">   
                     <a href="send-inquiry.html" class="text-white">
                         درخواست استعلام
                       </a>
                      </button>
    
                      <button class="btn-all btn-all-small btn-green" style="margin: 10px;font-weight: 600;">
                ...
                <div class="col-sm-8 col-mobile right-align">
                  <div class="owner" style="font-size: 0.8rem; font-weight: 650;">
                    <span class="badge" style="background-color: #e35d6a; color: white;">رتبه بالا</span>
                     فروشنده: 
                     <img  style="height: 12px;"> Sperling Werkzeugmaschinen   
               </div>
                ...
                <div class="col-sm col-mobile ver-pad">
                  <p class="prod-text">
                    لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ،
                     و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است، و برای شرایط فعلی تکنولوژی مورد نیاز،
                      و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد، کتابهای زیادی در شصت و سه درصد گذشته حال و آینده، شناخت فراوان
                      جامعه و متخصصان را می طلبد، تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی، و فرهنگ پیشرو در
                      زبان فارسی ایجاد کرد، در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها، و شرایط سخت تایپ به پایان رسد و

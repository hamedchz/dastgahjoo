        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 box-margin" wire:ignore >
                    <div class="card">
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-success mb-2 mr-2" style="float:left;margin-top:-37px;"  wire:click.prevent="newAdmin" ><i class="fa fa-plus-square"></i> ادمین جدید</button>
                            <button type="button" class="btn btn-primary mb-2 mr-2" style="float:left;margin-top:-37px;" wire:click.prevent="exportExl"><i class="fa fa-file-excel-o"></i> خروجی اکسل</button>
                            ...
                            <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                <thead>
                                    ...
                                    <th></th>
                                        ...
                                        <th id="user-setting2" class="amaliat" scope="col">عملیات</th>
                                         </tr>
                                </thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if($user->name == 'seller')
                                        <td class="account" id="user-name-pad"> <a href="{{route('admin.products')}}?vendor={{$us->vendor->id}}" target="_blank"> {{$us->name}}</a></td>
                                        @else
                                        <td class="account" id="user-name-pad">{{$us->name}}</td>
                                        @endif
                ...
                <a href=""  wire:click.prevent="removalConfirmation({{$us->id}})" style="font-size:20px;"><i class="fa fa-trash" style="color:#dc3545;"></i></a>
                                        ...
                                        <td id="user-setting2" class="amaliat">
                                            @if($us['pivot']->role_id == 1)
                                            <a href=""  wire:click.prevent="editAdmin({{$us}})" style="font-size:20px;"><i class="fa fa-edit" style="color:#35addc;"></i></a>
                                            <a href="{{route('admin.users-permissions',$us->id)}}"  style="font-size:20px;" title="سطح دسترسی کاربر"><i class="fa fa-user-secret"  style="color:#0cf504;"></i></a>
                                            @else

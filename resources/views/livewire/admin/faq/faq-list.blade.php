<div>
    <nav aria-label="خرده نان" class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">  سؤالات متداول </li>
        </ol>
    </nav>
                            ...
                            <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$prov->answer}}</td>
                                        <td>
                                            <a href="" wire:click.prevent = "edit({{$prov->id}})" style="font-size:20px;"><i class="fa fa-edit"  style="color:#04a9f5;"></i></a>
                                            <a href="" wire:click.prevent="removeConfirmation({{$prov->id}})"  style="font-size:20px;"><i class="fa fa-trash" style="color:#dc3545;"></i></a>
                                         </td>
                                        @empty
                                        <td align="center" colspan="2" style="background-color:#e1e1e1;">داده ای وجود ندارد</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
    ...
    @include('livewire.admin.faq.create')
    @include('livewire.admin.faq.delete')
...
@push('scripts')
    <script>
          $(document).ready(function(){
            ...
            window.addEventListener('hide-addProvince', event => {
            ...
            window.addEventListener('hide-deleteProvince', event => {
        ...
        window.addEventListener('show-provinceDelete' , event =>{

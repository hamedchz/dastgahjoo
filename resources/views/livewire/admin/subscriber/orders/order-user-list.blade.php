                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                <thead>
                                    <tr>
                                         <th id="edit-remove1">عنوان</th>
                                         <th id="edit-remove2">عنوان</th>
                                        <th>موضوع</th>
                                        <th>شماره محصول</th>
                                        <th class="status-semat">وضعیت</th>
                                        <th class="status-semat">تاریخ و ساعت</th>
                                        <th id="edit-remove2">#</th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                            ...
                                            <td id="edit-remove1">
                                            {{$msg->title}}
                                            <a class="btn-sm btn-success" href="" wire:click.prevent="showMessage({{$msg->id}})" style="margin-right: 8%;font-size: 10px;padding: 2px auto;">اطلاعات بیشتر</a>
                                        </td>
                                         

                                        <td id="edit-remove2">{{$msg->title}}</td>
                                        <td>

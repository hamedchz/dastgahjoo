<div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 box-margin">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-2"> لیست استان ها</h4>
                            ...
                            <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="" wire:click.prevent = "editProvince({{$prov->id}})" style="font-size:20px;"><i class="fa fa-edit"  style="color:#04a9f5;"></i></a>
    ...
    @include('livewire.admin.location.province.delete')

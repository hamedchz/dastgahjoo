<div>
    <nav aria-label="خرده نان" class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">پیام مناسبتی</li>
        </ol>
    </nav>
<div class="data-table-area">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-lg-7 box-margin height-card">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12 box-margin">
                            <div class="card">
                                <div class="card-body" wire:ignore>
                                    <h4 class="card-title mb-2">  پیام مناسبتی </h4>
                                    <span class="text-danger" style="font-sixe:12px;">(در آن واحد فقط یک پیام میتواند فعال باشد)</span>
                                    ...
                                    <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
                                            @forelse($congratulations as $prov)
                                            <tr>
                                                <td>
                                                    <div  ><img class="" style="width: 75px;height:75px;"  src="{{asset($prov->image)}}" alt="avatar"></div>
                                                </td>
                                                <td>
            ...
            <div class="col-12 col-lg-5 box-margin height-card">
                <div class="card card-body">
                    <h4 class="card-title">{{ $editStatus ? 'ویرایش پیام': 'پیام  جدید'}}   </h4>
                    <hr>
                    <div class="row">

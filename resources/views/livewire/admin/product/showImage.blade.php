  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="hgg">گالری  </h5>
        ...
        <div class="row" >
          ...
          <div  class="col-md-4">
            <div class="card modal-fancy-img" style="width: 8rem;" >
              <img class="card-img-top"  data-fancybox="gallery" src="{{asset($img['image'])}}" alt="" style="width: 800px;height: auto;display:block !important;">

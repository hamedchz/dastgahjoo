<div>
    <nav aria-label="خرده نان" class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">  درخواست های  رسیده     </li>
        </ol>
    </nav>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between ">
                                <h4 class="card-title mb-2">   درخواست های  رسیده     </h4>
                        </div>
                            ...
                            <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                          ...
                                          <td id="edit-remove1" class="status-semat">
                                          {{$msg->phone}}
                                        ...
                                        <td id="edit-remove" >{{$msg->phone}}</td>

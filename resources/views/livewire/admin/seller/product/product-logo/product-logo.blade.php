<div>
    ...
    <nav aria-label="خرده نان" class="container-fluid">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">لوگو محصول </li>
        </ol>
    </nav>
            ...
            <div class="row">
                <div class="col-12 col-lg-9 box-margin height-card">
                    <div class="card card-body">
                        <h4 class="card-title">لوگو محصول</h4>
                        <hr>
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                ...
                                <div class="col-lg-3 col-md-3">
                                  <div class="card" style="width: 10rem;">
                                      <img class="card-img-top" src="{{asset('storage/logos/'.$images->logo)}}" alt="">
                ...
                <div class="col-12 col-lg-3 box-margin height-card">
                    <div class="card card-body">
                        <h4 class="card-title">لوگو جدید</h4>
                        <hr>
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <form wire:submit.prevent="imageStore">
                                    ...
                                    <div class="input-group cust-file-button mb-3">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input form-control" id="f_p_v_up1"  wire:model.defer="photo">
                                            <label class="custom-file-label" for="f_p_v_up1">تصویر لوگو</label>
                                        </div>
    ...
    @include('livewire.admin.seller.product.product-logo.delete')

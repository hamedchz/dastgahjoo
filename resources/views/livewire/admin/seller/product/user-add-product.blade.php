<div>
  <nav aria-label="خرده نان" class="container-fluid">
      <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">ماشین آلات جدید</li>
      </ol>
  </nav>
              ...
              <div class="col-12 box-margin">
                  <div class="card">
                      ...
                      <div class="d-flex justify-content-between ">
                          <h4 class="card-title mb-2"> ماشین آلات جدید</h4>
                      </div>
                          <hr>
                          ...
                          <div class="row">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <select class="custom-select  @error('subcategory_id') is-invalid @enderror" id="subcategory" wire:model.defer="state.subcategory_id">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                  ...
                                  <input type="number" wire:model.defer="state.price"  class="form-control @error('price') is-invalid @enderror" id="price" placeholder="قیمت " oninput="removeError('#price')">
                                ...
                                <div class="form-group col-md-6">
                                  ...
                                  <select class="custom-select @error('isStock') is-invalid @enderror" id="isStock">
                                    <option selected >انتخاب کنید</option>
                                ...
                                <div class="form-group col-md-6">
                                  ...
                                  <select class="custom-select @error('isInstallments') is-invalid @enderror" id="isInstallments">
                                    <option selected >انتخاب کنید</option>
                                ...
                                <div class="form-group col-md-6">
                                  ...
                                  <select class="custom-select @error('isSold') is-invalid @enderror" id="isSold">
                                    <option selected >انتخاب کنید</option>
                            ...
                            @endif
                              <div class="form-group col-lg-12 col-md-12">
                                ...
                                <div class="input-group cust-file-button mb-3">
                                  <div class="custom-file">
                                    ...
                                    @error('image')<div style="width: 100%;margin-top: 0.25rem;font-size: 80%;color: #dc3545;">{{ $message }}</div> @enderror
                              </div>
                              ...
                              <div class="form-group col-lg-12 col-md-12" >
                                ...
                                <div class="input-group cust-file-button mb-3">
                                  <div class="custom-file">
                                      <input type="file" class="custom-file-input form-control  @error('logo') is-invalid @enderror" id="f_p_v_up2" wire:model.defer="logo">
                                      <label class="custom-file-label" for="inputGroupFile03" id="logoDiv">عکس لوگو </label>
                                    </div>
                              </div>
                              <div class="filearray2 row mt-5 justify-content-center align-items-center" wire:ignore></div>
                              ...
                              <div class="form-group col-lg-12 col-md-12">
                              <label for="video">ویدیو (<span style="color:red;">فرمت ویدئو MP4 وحداکثر اندازه ویدئو 10 مگابایت</span>)  :</label>
                                <div class="input-group cust-file-button mb-3">
                                  <div class="custom-file">
                                      <input type="file" class="custom-file-input form-control  @error('video') is-invalid @enderror" id="f_p_v_up3" wire:model.defer="video">
                                      <label class="custom-file-label" for="inputGroupFile03"> ویدیو </label>
                                    </div>

                              </div>
                              <div class="d-none filearray3  text-success " wire:ignore.self>ویدیو اضافه شد</div>
...
background: none !important;
  ...
  */
  ...
  <script>
      $(document).on('ready',()=>{
      $("#f_p_v_up3").on('change',function(){
      console.log('jkljkljk')
          document.querySelector('.filearray3').classList.remove('d-none')
      });
    });
      $(document).on('ready',()=>{
      $("#f_p_v_up1").on('change',function(){
          ...
          for(let i=0;i<this.files.length;++i){
           ...
           $("#f_p_v_up2").on('change',function(){
              document.querySelector('#logoDiv').classList.add('activeInput')

          $(".filearray2").empty();//you can remove this code if you want previous user input
          for(let i=0;i<this.files.length;++i){
              let filereader = new FileReader();
              let $img=jQuery.parseHTML("<img src='' class='pr-2 mt-2 shadow' style='width:200px;height:200px;' >");
              filereader.onload = function(){
